    ...
    <div className='header'>
        <div className='header-container'>
            ...
            <div className='nav'  onClick={fun}>
                ...
                <a href='/about' className='mob'>ABOUT</a>
                <a href='/chit-plans' className='mob'>CHIT PLANS </a>
                <a href='/branches' className='mob'>BRANCHES</a>
                <a href='/contact' className='mob'>CONTACT</a>
            </div>
